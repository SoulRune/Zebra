...
- (void)layoutNaviationButtons {
    if (@available(iOS 26, *)) {
        self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(addSections)];
    } else {
